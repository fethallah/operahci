...
//		void Swap(Script& b);
		...
		*/
		...
		/// Move attachments from the Script object and to the \a detached list. If the parameter attachment is a default-constructed object, all attachments will be moved, otherwise only those matching the non-empty fiels in \a pattern.
