...
class DI_MemBlock ThreadSharable: public Nbaseutil::mb_malloced {
	...
	mutable Nbaseutil::boost_mutex mutex_;
...
protected:
	ThreadSharable(): refcount_(0), weak_pointers_(NULL) {}
...
protected:
	ThreadSharable(const ThreadSharable& b): refcount_(0), weak_pointers_(NULL) {} // refcounts do not copy
	ThreadSharable& operator=(const ThreadSharable& b){return *this;} // refcounts do not copy
protected:
...
public:
	/// Default ctor
	ThreadSafeRefcountable(): refcount_(0) {}

	/// Copy ctor, to avoid copying the refcount.
	ThreadSafeRefcountable(const ThreadSafeRefcountable& b): refcount_(0) {}
