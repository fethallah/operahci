...
namespace NIMacro {
	...
	*/
	...
	public:
		...
		enum level_t {
			/// Used for switching logging off in the SetLogging() call, same as level0_console_output.
			level0_no_logging=0,
			/// Used for unconditional logging in the Log() call, same as level0_no_logging.
			level0_console_output=0,
