...
/// Return true is string is a decimal or hexadecimal integer number or a floating-point number. In floating-point numbers, accepts only a dot as the decimal point character.
DI_baseutil bool is_numeric_dot(const safestring& s);

/// Return true is string is a decimal or hexadecimal integer number or a floating-point number, or an Acapella predefined numeric constant. In floating-point numbers, accepts only a dot as the decimal point character.
DI_baseutil bool is_numeric_acapella_dot(const safestring& s);
